 ...
 *
 * Crea otra clase que se encargue de lanzar TicketCompra.java como un proceso. Además, redirecciona la salida estándar
 * para que escriba la salida estándar en un fichero. Cada vez que escriba en el fichero debe concatenar el nuevo
 * contenido, no sobreescribir el anterior. La entrada del proceso debe ser la estándar, es decir, el teclado.
 */
