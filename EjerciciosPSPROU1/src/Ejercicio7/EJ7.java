...
public class EJ7 {
     ...
     * Para lo que usaremos el método startPipeline. Para ello, vamos a crear 3 clases distintas que serán los distintos
     * procesos a lanzar:
     * Clase 1: Va a generar 10 direcciones IP de forma aleatoria y las va a imprimir por la salida estándar.
     * Clase 2: Va a leer 10 direcciones IP de teclado y va a imprimir por consola únicamente aquellas que pertenezcan a
     * las clases A, B o C.
     * Clase 3: Va a leer una serie de direcciones IP por teclado (no sabemos cuántas van a llegar) y va a imprimir por
     * consola la dirección IP y a continuación la clase a la que pertenece.
     ...
     * CONSEJO: Establece para los tres procesos la salida de error estándar, para en caso de que haya algún error durante
     * la ejecución, éste se pinte en la consola.
     */
